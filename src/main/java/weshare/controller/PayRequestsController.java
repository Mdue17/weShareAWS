...
public class PayRequestsController {
    ...
    public static final Handler paymentreceived = context -> {
        ...
        context.render("paymentrequests_recieved.html", viewModel);
    };
    ...
    public static Handler addPaymentRequest = context -> {
        ...
        expense.requestPayment(person, MoneyHelper.amountOf(amount), LocalDate.now());
